...
part 'scholarship_models.g.dart';

@JsonSerializable()
class ScholarshipModels {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory ScholarshipModels.fromJson(Map<String, dynamic> json) =>_$ScholarshipModelsFromJson(json);

  Map<String, dynamic> toJson() => _$ScholarshipModelsToJson(this);
